...
//   var text_encript = Aes.Ctr.encrypt( $('#texto').val() , $('#pass').val(), 256 );

  
//   $('#crip').text(text_encript);
  
//   })


// $('#dec_encrip').click(function(){ 
  
//   $('#dec_crip').show();
  
//   var text_decript = Aes.Ctr.decrypt($('#dec_texto').val() , $('#dec_pass').val(), 256 );
  

//   $('#dec_crip').text(text_decript);
